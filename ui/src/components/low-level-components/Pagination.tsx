...
const PaginationControl = ({ totalPages }: PostListData) => {
  ...
  const prevArrow =
    '.MuiPagination-ul > li:first-of-type > .MuiPaginationItem-previousNext:before ';
  const prevArrowText =
    '.MuiPagination-ul > li:first-of-type > .MuiPaginationItem-previousNext:after';

  const nextArrow =
    '.MuiPagination-ul > li:last-of-type > .MuiPaginationItem-previousNext:after';
  const nextArrowText =
    '.MuiPagination-ul > li:last-of-type > .MuiPaginationItem-previousNext:before';
